...
import ru.kabzex.ui.vaadin.dto.money.IncomeDto;
import ru.kabzex.ui.vaadin.dto.money.IncomeFilter;

import java.util.Collection;
import java.util.List;

public class IncomeBody extends AbstractEditableGridPagePart<IncomeDto, IncomeFilter> {
    private static final List<String> ALLOWED = List.of(Roles.EMPLOYEE, Roles.ADMIN);
    @Getter
    private final Tab tab = new Tab("Платежи");

    @Override
    protected IncomeFilter initFilter() {
        return null;
    }
    ...
    @Override
    public IncomeDto getEmptyDto() {
        return new IncomeDto();
    }

    @Override
    protected Grid<IncomeDto> initGrid() {
        return null;
    }
}
